...
namespace MotronicSuite
{
    public partial class ctrlCompressorMapEx : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            string imagename = "MotronicSuite.Compressormaps.t25_55_saab.JPG";
            switch (compressorMap)
            {
                case CompressorMap.T25_55:
                    imagename = "MotronicSuite.Compressormaps.t25_55_saab.JPG";
                    toolStripComboBox1.SelectedIndex = 0;
                    break;
                case CompressorMap.T25_60:
                    imagename = "MotronicSuite.Compressormaps.t25-60trim.JPG";
                    toolStripComboBox1.SelectedIndex = 1;
                    break;
                case CompressorMap.TD04:
                    imagename = "MotronicSuite.Compressormaps.td04-15g-cfm.JPG";
                    toolStripComboBox1.SelectedIndex = 2;
                    break;
                case CompressorMap.TD0416T:
                    imagename = "MotronicSuite.Compressormaps.td04h-16t-cfm.JPG";
                    toolStripComboBox1.SelectedIndex = 3;
                    break;
                case CompressorMap.TD0418T:
                    imagename = "MotronicSuite.Compressormaps.td04h-18t-cfm.JPG";
                    toolStripComboBox1.SelectedIndex = 4;
                    break;
                case CompressorMap.TD0419T:
                    imagename = "MotronicSuite.Compressormaps.td04h-19t-cfm.JPG";
                    toolStripComboBox1.SelectedIndex = 5;
                    break;
                case CompressorMap.TD0620G:
                    imagename = "MotronicSuite.Compressormaps.td06h-20g-cfm.JPG";
                    toolStripComboBox1.SelectedIndex = 6;
                    break;
                case CompressorMap.GT2871R:
                    imagename = "MotronicSuite.Compressormaps.gt2871r-48.jpg";
                    toolStripComboBox1.SelectedIndex = 7;
                    break;
                case CompressorMap.GT28RS:
                    imagename = "MotronicSuite.Compressormaps.gt28rscompress.JPG";
                    toolStripComboBox1.SelectedIndex = 8;
                    break;
                case CompressorMap.GT3071R86:
                    imagename = "MotronicSuite.Compressormaps.GT3071R86.jpg";
                    toolStripComboBox1.SelectedIndex = 9;
                    break;
                case CompressorMap.GT30R:
                    imagename = "MotronicSuite.Compressormaps.gt30rcompress.JPG";
                    toolStripComboBox1.SelectedIndex = 10;
                    break;
                case CompressorMap.GT40R:
                    imagename = "MotronicSuite.Compressormaps.gt40rcompress.JPG";
                    toolStripComboBox1.SelectedIndex = 11;
                    break;
                case CompressorMap.HX40W:
                    toolStripComboBox1.SelectedIndex = 12;
                    imagename = "MotronicSuite.Compressormaps.hx40w.jpg";
                    break;
            }
            ...
            DrawLineonImage(bmp);
            scalablePictureBox1.Picture = null;
            string tempImagePath = Path.GetTempPath() + "\\VMCMImage.bmp";
