...
namespace Plot3D
{
    ...
    public static class FunctionCompiler
    {
        ...
        public static CompiledFunction Compile(int parametersCount, string functionBody)
        {
            ...
            {
                //throw new FunctionNotCompiledException(Motronic.Properties.Resources.FunctionCompiler_SemicolonException);
            }
            ...
            string str = string.Empty;// string.Format(Motronic.Properties.Resources.FunctionCompiler_EvalClass, strb.ToString(), typeof(CompiledFunction).Namespace);
