...
namespace MotronicSuite
{
    abstract public class IMapViewer : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public abstract bool mapAllowsNegatives
        {
            get;
            set;
        }
        ...
        public abstract AxisCollection AllAxis
        {
            get;
            set;
        }

        public abstract SymbolHelper XAxisSymbol
        {
            get;
            set;
        }
        public abstract SymbolHelper YAxisSymbol
        {
            get;
            set;
        }

        public abstract FileType CurrentFiletype
        {
            get;
            set;
        }
