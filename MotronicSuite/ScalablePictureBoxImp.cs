...
///
/// Motronic.NET makes use of this control to display pictures.
/// Please visit <a href="http://www.Motronic.net/en/">http://www.Motronic.net/en/</a>
/// </summary>
namespace MotronicSuite
{
    ...
    internal partial class ScalablePictureBoxImp : System.Windows.Forms.UserControl
    {
		...
		public ScalablePictureBoxImp()
		{
            ...
            // Read icon images
            fitWidthImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("MotronicSuite.showFitWidth.gif");
            showWholeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("MotronicSuite.showWhole.gif");
            showActualSizeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("MotronicSuite.showActualSize.gif");

            // read cursors
            zoomInCursor = Util.CreateCursorFromFile("MotronicSuite.ZoomIn32.cur");
            zoomOutCursor = Util.CreateCursorFromFile("MotronicSuite.ZoomOut32.cur");
