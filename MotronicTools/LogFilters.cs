...
namespace MotronicTools
{
    public class LogFilters
    {
        ...
        public MotronicTools.LogFilterCollection GetFiltersFromRegistry()
        {
            ...
            try
            {
                RegistryKey testKey = TempKey.OpenSubKey("MotronicSuite");
                using (RegistryKey Settings = TempKey.CreateSubKey("MotronicSuite\\LogFilters"))
                {
                    if (Settings != null)
                    {
